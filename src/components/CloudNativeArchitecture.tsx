          ...
          <div className="flex flex-col lg:flex-row items-center">
            <div className="w-full lg:w-1/2">
              ...
              <p className="text-lg mb-6">
                Discover the principles, patterns, and practices of cloud-native
                architecture that enable organizations to build and run scalable
            ...
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-6">
                <p className="text-gray-600">
                  ...
                  running applications that exploits the advantages of the cloud
                  computing delivery model. It's about how applications are
                  created and deployed, not where.
                </p>

                <p className="text-gray-600">
                  This architectural approach enables organizations to build and
                  run scalable applications in modern, dynamic environments such
                  as public, private, and hybrid clouds. Containers, service
                  meshes, microservices, immutable infrastructure, and
  ...
  <div className="container px-4 md:px-6">
    <div className="flex flex-col items-center text-center space-y-6 max-w-3xl mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 pt-6">
        <button className="bg-white text-blue-600 hover:bg-white/90 px-6 py-3 rounded-lg flex items-center justify-center">
          Get Started Today
...
export default CloudNativeArchitecture;
