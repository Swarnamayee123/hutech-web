    ...
    <div>
      ...
      <section
        ...
        style={{
          ...
          //  height: "100vh",
          marginTop: "6rem",   paddingLeft: "7.5vw",
          paddingRight: "5.5vw",
          width: "100vw",
        }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <p className="text-lg text-gray-700 leading-relaxed mb-6">
                We stay current with all regulatory updates to ensure your cloud
                environment remains compliant with every necessary standard. The
                risks associated with compliance and guarding sensitive
                information from breaches can seem daunting and overwhelming.
                However, by choosing Hutech Solutions, you can rest assured that
                your digital assets are safe.
              </p>

              <p className="text-lg text-gray-700 leading-relaxed">
                We leverage our experience and technology to create custom
                solutions that will minimize risk and introduce a new culture of
                security and compliance into your organization. We'll put the
                necessary controls in place, allowing you to focus on driving
                your business, confident that your data is secured and compliant
                in today's digital landscape, now, and in the future.
              </p>
            </div>
          </div>
        </div>
