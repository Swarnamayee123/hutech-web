...
export default function About() {
  return (
    <>
          <SEO title="Cloud Cost Optimization Services | Maximize ROI & Minimize Waste" description="Reduce your cloud spending and improve ROI with expert cloud cost optimization services. Identify unused resources, right-size workloads, and save big." />
    <div>
      {/* Hero Section */}
      <section
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="mt-16">
              ...
              <p className="text-gray-600 mb-8">
                At HutechSolutions, we use a comprehensive approach to help
                customers reduce their cloud spend. Our cloud cost optimization
                services will help your company strike a balance between cost
                and performance while keeping cloud bills under control.
              </p>
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div
                key={index}
                className="bg-white rounded-lg shadow-sm h-full text-center">
                <div className="p-8">
