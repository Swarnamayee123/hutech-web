...
export default function CloudConsulting() {
  return (
    <>
    <SEO title="AWS Cloud Consulting Services | Optimize, Migrate & Scale on AWS" description="Unlock the full potential of AWS with expert cloud consulting services. We help you migrate, optimize, and scale your infrastructure securely and efficiently." />
      ...
      <section className="py-20 bg-gray-100">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 mb-0 pt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 justify-center">
            <div className="bg-white p-6 rounded-lg shadow-sm h-full text-center">
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {[
              ...
              <div
                key={index}
                className="bg-white p-6 rounded-lg shadow-sm h-full hover:shadow-md transition-shadow">
        ...
        <div className="max-w-6xl mx-auto px-4 relative z-10">
          <div className="text-center text-white">
            ...
            <a
              ...
              style={{
                background: "#fff", // or any light/dark color
