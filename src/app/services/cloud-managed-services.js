...
export default function CloudManagedService() {
  const features = [
    {
      icon: Cpu,
  ...
  return (
    <>
       <SEO
        title="Cloud Managed Services | 24/7 Expert Support by Hutech Solutions"
        description="Simplify cloud operations with Cloud Managed Services from Hutech Solutions. Get 24/7 monitoring, performance optimization, and cost-effective management."
      />
      <section
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {services.map((service, index) => (
              <div
                key={index}
                className="bg-white rounded-xl p-6 hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 group border border-gray-200">
