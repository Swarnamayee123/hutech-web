...
export default function CloudMigration() {
  return (
    <>
    <SEO title="Cloud Migration Services | Secure, Scalable & Cost-Effective Solutions" description="Accelerate your digital transformation with our expert cloud migration services. Reduce costs, boost security, and scale effortlessly with tailored solutions." />
        ...
        <div className="max-w-6xl mx-auto px-4 ">
          <div className="flex justify-center">
            <div className="w-full lg:w-10/12">
              ...
              <div className="bg-blue-50 p-6 lg:p-10 rounded-2xl border border-blue-200 shadow-sm">
