...
// import CloudMigration from "./CloudMigration.js";

const MobileServices = ({ closeMenu }) => {
  ...
  return (
    <div className="w-full">
      <button
        ...
        className="flex justify-between items-center w-full text-gray-700 dark:text-gray-200 hover:text-cyan-600 dark:hover:text-cyan-400 transition-colors font-semibold">
        <span>Services</span>
        <svg
          ...
          {servicesLinks.map(([path, label]) => (
            <li key={path}>
              <Link
                ...
                <span className="block px-2 py-1 hover:bg-gray-100 dark:hover:bg-slate-700 rounded">
                  {label}
                </span>
              </Link>
            </li>
          ...
          <div className="max-w-screen-2xl mx-auto pl-8 pr-[14rem] py-10 grid grid-cols-1 md:grid-cols-4 items-start">
            {[...Array(3)].map((_, i) => (
              <ul key={i} className="space-y-2">
                {[...servicesLinks.slice(i * 5, (i + 1) * 5)].map(
                  ([path, label]) => (
                    <li key={path}>
            ...
            <div
              ...
              <div className="flex flex-col justify-center space-y-4 text-left pl-6">
                ...
                <p className="block px-2 py-1 text-gray-700 dark:text-gray-300">
                ...
                <div className="flex flex-col space-y-2 max-w-[11rem]">
                  <a
                    ...
                    className="px-6 py-3 bg-gradient-to-r from-cyan-500 to-blue-500 text-white rounded-lg text-sm font-semibold hover:opacity-90 transition-opacity">
                    Explore Services
                  </a>
                </div>
              </div>
